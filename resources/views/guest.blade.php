                                    ...
                                    <div class="row">
                                            ...
                                            <fieldset class="row mb-3" id="s1">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="sesi1"" value="{{ $s1->id }}" required
                                                        {{ $s1->stok <= 0 ? 'disabled' : '' }}>
                                                            <label class="form-check-label" for="br1">
                                                                {{ $s1->nama_tiket }}
                                                                <h9 style="color: {{ $s1->stok <= 0 ? 'red' : 'rgb(0, 216, 36)' }};">
                                                                {{ $s1->stok }} Tiket</h9>
                                                            </label>
                                                    </div>
                                                    @endforeach
                                        ...
                                        <div class="form-group col-6">
                                            <fieldset class="row mb-3" id="s2">
                                                ...
                                                <div class="col-sm-10">
                                                    @foreach ($sesi2 as $s2)
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="sesi2" value="{{ $s2->id }}" required
                                                            {{ $s2->stok <= 0 ? 'disabled' : '' }}>
                                                                <label class="form-check-label">
                                                                    Kelas {{ $s2->nama_tiket }}
                                                                    <h9 style="color: {{ $s2->stok <= 0 ? 'red' : 'rgb(0, 216, 36)' }};">
                                                                        ({{ $s2->stok }} Tiket)</h9>
                                                                </label>
                                                        </div>
                                                    @endforeach
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input id="first_name" type="text" class="form-control" name="hp"
                                                placeholder="ex. 6281290959xxx" required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            {{-- <button {{ (($a1> 0 || $a2 > 0 || $a3 > 0 || $a4 > 0 || $a5 > 0 ) &&
                                                ($b1 > 0 || $b2 > 0 || $b3 > 0 || $b4 > 0 || $b5 > 0)) ? '' : 'disabled'
                                                }}
